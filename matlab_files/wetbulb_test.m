...
T = ncread('~/Documents/sandbox/MERRA2_100.instM_3d_ana_Np.198001.nc4.nc','T');
lat = ncread('~/Documents/sandbox/MERRA2_100.instM_3d_ana_Np.198001.nc4.nc','lat');
lon = ncread('~/Documents/sandbox/MERRA2_100.instM_3d_ana_Np.198001.nc4.nc','lon');
lev = ncread('~/Documents/sandbox/MERRA2_100.instM_3d_ana_Np.198001.nc4.nc','lev');
time = ncread('~/Documents/sandbox/MERRA2_100.instM_3d_ana_Np.198001.nc4.nc','time');


% read in CAM output 1.0
% T = ncread('~/projects/modelOutput/gcmexpt/CAM4/40yr_1361/wbpt_pressure_.nc','T');
% lat = ncread('~/projects/modelOutput/gcmexpt/CAM4/40yr_1361/wbpt_pressure_.nc','lat');
% lon = ncread('~/projects/modelOutput/gcmexpt/CAM4/40yr_1361/wbpt_pressure_.nc','lon');
% lev = ncread('~/projects/modelOutput/gcmexpt/CAM4/40yr_1361/wbpt_pressure_.nc','lev');
% time = ncread('~/projects/modelOutput/gcmexpt/CAM4/40yr_1361/wbpt_pressure_.nc','time');
...
%% subsample everything to make these tests faster
...
% 
% %Open the file
% ncid = netcdf.create(['./wbpt_1361.nc'],'NC_WRITE');
%  
...
% pspan = [p(ilev) 1e5];
% options = odeset('reltol',1e-6');
% [pw,Tw] = ode45(@(p,T) pseudoadiabatig(p,T,Rd,Md,cpd,'h2o','l'), pspan,To, options);