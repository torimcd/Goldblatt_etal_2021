...
% read in CAM output 0.8
T = ncread('~/projects/modelOutput/gcmexpt/CAM4/0.8/wbpt_pressure_.nc','T');
lat = ncread('~/projects/modelOutput/gcmexpt/CAM4/0.8/wbpt_pressure_.nc','lat');
lon = ncread('~/projects/modelOutput/gcmexpt/CAM4/0.8/wbpt_pressure_.nc','lon');
lev = ncread('~/projects/modelOutput/gcmexpt/CAM4/0.8/wbpt_pressure_.nc','lev');
time = ncread('~/projects/modelOutput/gcmexpt/CAM4/0.8/wbpt_pressure_.nc','time');
...
%Open the file
ncid = netcdf.create(['./wbpt_0.8.nc'],'NC_WRITE');
