...
T = ncread('~/projects/modelOutput/gcmexpt/CAM4/1.0/wbpt_pressure_.nc','T');
lat = ncread('~/projects/modelOutput/gcmexpt/CAM4/1.0/wbpt_pressure_.nc','lat');
lon = ncread('~/projects/modelOutput/gcmexpt/CAM4/1.0/wbpt_pressure_.nc','lon');
lev = ncread('~/projects/modelOutput/gcmexpt/CAM4/1.0/wbpt_pressure_.nc','lev');
time = ncread('~/projects/modelOutput/gcmexpt/CAM4/1.0/wbpt_pressure_.nc','time');
