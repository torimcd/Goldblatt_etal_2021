...
if isfile(filepath)
    ...
    error('Prepared input file does not exist, please try running the figure 3 python script first')
end
...
if isfile(filepath)
    ...
    error('CAM5 prepared input file does not exist, please try running the figure 3 python script first')
