...
ax1.set_title('Radiative Forcing - Top of Atmosphere')
ax1.set_xlabel(r'$\mathsf{CO_2}$' + ' (ppmv)')
ax1.set_ylabel('Forcing ' + r'$\mathsf{W/m^2}$')
ax1.set_xscale("log")
...
ax2.set_title('Radiative Forcing - 200hpa')
ax2.set_xlabel(r'$\mathsf{CO_2}$' + ' (ppmv)')
ax2.set_ylabel('Forcing ' + r'$\mathsf{W/m^2}$')
ax2.set_xscale("log")
...
ax3.set_title('Radiative Forcing - Surface')
ax3.set_xlabel(r'$\mathsf{CO_2}$' + ' (ppmv)')
ax3.set_ylabel('Forcing ' + r'$\mathsf{W/m^2}$')
ax3.set_xscale("log")
