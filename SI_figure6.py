...
casenames = ['1.05','1.025','1.0','0.975','0.95','0.925','0.9'] 
...
while i<2:
	...
	for y in casenames:
		...
		# Plot 
		cs = m.pcolormesh(lon2d,lat2d,np.squeeze(fld), cmap='RdBu_r', latlon='True', vmin=-40, vmax=40)
		fig.add_subplot(ax)
...
fig.savefig("figure2_cam5.pdf", bbox_inches='tight')
