...
cam3_flux_330 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19]

cam3_pressure = ds.variables['Pres'][:]
print(ds.variables['Pres'][19])
...
cam3_flux_100 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
cam3_flux_500 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
cam3_flux_1000 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
cam3_flux_2000 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
cam3_flux_5000 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
cam3_flux_10000 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
cam3_flux_20000 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
cam3_flux_30000 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
cam3_flux_35000 = ds.variables['FSWNET'][19]*1.630705885*0.501472063 + ds.variables['FLWNET'][19] - cam3_flux_330
...
# CAM5
fluxes_cam5 = np.array([np.reshape(total_flux_100, 42)[23], np.reshape(total_flux_330, 42)[23] - np.reshape(total_flux_330, 42)[23], np.reshape(total_flux_500, 42)[23], np.reshape(total_flux_1000, 42)[23],np.reshape(total_flux_1500, 42)[23], np.reshape(total_flux_2000, 42)[23], np.reshape(total_flux_5000, 42)[23], np.reshape(total_flux_10000, 42)[23],np.reshape(total_flux_20000, 42)[23], np.reshape(total_flux_30000, 42)[23], np.reshape(total_flux_35000, 42)[23]])
...
# SMART
fluxes_smart = np.array([smart_flux_100[10], smart_flux_330[10] - smart_flux_330[10], smart_flux_500[10], smart_flux_1000[10], smart_flux_1500[10], smart_flux_2000[10], smart_flux_5000[10], smart_flux_10000[10], smart_flux_20000[10], smart_flux_30000[10], smart_flux_35000[10]])
...
plt.title('Radiative Forcing - 200hPa')
plt.xlabel('CO2')
...
plt.show()
f.savefig('rad_forcing_200hPa_log.pdf', bbox_inches='tight')
